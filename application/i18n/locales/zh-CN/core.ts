...
`,
  ...
  'vault.nav.dataRelay': '数据中转',

  // Data Relay
  'dataRelay.new': '新建中转',
  'dataRelay.searchPlaceholder': '搜索中转规则...',
  'dataRelay.startAll': '全部启动',
  'dataRelay.stopAll': '全部停止',
  'dataRelay.viewGrid': '网格视图',
  'dataRelay.viewList': '列表视图',
  'dataRelay.saved': '数据中转已保存',
  'dataRelay.transferred': '已传输',
  'dataRelay.empty.title': '还没有数据中转',
  'dataRelay.empty.description': '把一台设备上的文件夹实时中转到另一台设备的文件夹中。',
  'dataRelay.error.saveFailed': '保存数据中转失败',
  'dataRelay.status.inactive': '已停止',
  'dataRelay.status.connecting': '连接中',
  'dataRelay.status.active': '传输中',
  'dataRelay.status.error': '错误',
  'dataRelay.status.unknown': '未知',
  'dataRelay.writeMode.overwrite': '覆盖',
  'dataRelay.writeMode.append': '追加',
  'dataRelay.form.newTitle': '新建数据中转',
  'dataRelay.form.editTitle': '编辑数据中转',
  'dataRelay.form.labelPlaceholder': '例如：Windows 日志到 Linux',
  'dataRelay.form.sourceHost': '源设备',
  'dataRelay.form.sourcePath': '源路径',
  'dataRelay.form.sourcePathPlaceholder': '/var/log/',
  'dataRelay.form.sourcePathHint': '在源设备上选择要中转的文件夹，其中的文件会实时传输。',
  'dataRelay.form.sourceCommand': '源命令',
  'dataRelay.form.sourceCommandPlaceholder': 'tail -f /var/log/app.log',
  'dataRelay.form.sourceCommandHint': '在源设备上执行，其标准输出会被中转。',
  'dataRelay.form.destHost': '目标设备',
  ...
  'dataRelay.form.autoStartHint': 'Netcatty 启动时自动开始该中转。',
  'dataRelay.form.selectHost': '选择设备',
  'dataRelay.browser.sourceTitle': '选择源文件夹',
  'dataRelay.browser.destTitle': '选择目标文件夹',
  'dataRelay.browser.select': '选择',
  'dataRelay.browser.selectFolder': '选择此目录',
  ...
  'dataRelay.compare.comparing': '正在递归比较…',
  'dataRelay.compare.comparingProgress': '已扫描 {scanned} 项，{diffs} 处差异',
  'dataRelay.compare.dialogTitle': '同步',
  'dataRelay.compare.dialogHint': '选择同步方向，勾选要传输的差异项。',
  'dataRelay.compare.direction': '方向',
  'dataRelay.compare.direction.toDest': '源 → 目标',
  'dataRelay.compare.direction.toSource': '目标 → 源',
  'dataRelay.compare.direction.both': '双向',
  'dataRelay.compare.search': '筛选路径',
  'dataRelay.compare.selectAll': '全选',
  'dataRelay.compare.selectNone': '全不选',
  'dataRelay.compare.sync': '同步',
  'dataRelay.compare.checkedCount': '已选 {checked} / {total}',
  'dataRelay.compare.copyingProgress': '正在复制 {done}/{total}…',
  'dataRelay.compare.noDirectionItems': '当前方向没有可复制的项。',
  'dataRelay.compare.summary.same': '相同',
  'dataRelay.compare.summary.leftOnly': '仅源',
  'dataRelay.compare.summary.rightOnly': '仅目标',
  'dataRelay.compare.summary.different': '不同',
  'dataRelay.compare.kind.newerLeft': '源更新',
  'dataRelay.compare.kind.newerRight': '目标更新',
  'dataRelay.compare.kind.size': '大小不同',
  'dataRelay.compare.kind.type': '类型不同',
  'dataRelay.compare.kind.content': '内容不同',
  'dataRelay.compare.noDifferences': '两侧文件夹递归比较后一致。',
  'dataRelay.compare.logEmpty': '比较会弹出差异清单。选择方向并同步勾选的文件。',
  'dataRelay.compare.logHint': '复制和比较记录显示在这里。',
  'dataRelay.scan.settings': '扫描设置',
  'dataRelay.scan.interval': '扫描间隔',
  'dataRelay.scan.intervalHint': '中转运行时，启动后立即扫描一次，之后按此间隔查找新增或已修改的文件。',
  'dataRelay.scan.seconds': '秒',
  'dataRelay.scan.minutes': '分钟',
  'dataRelay.scan.mode': '上传范围',
  'dataRelay.scan.mode.mtime': '按添加/修改时间',
  'dataRelay.scan.mode.mtimeHint': '按大小和修改时间比较源与目标，只复制源上新增或更新的文件。',
  'dataRelay.scan.mode.checkpoint': '按上次上传记录',
  'dataRelay.scan.mode.checkpointHint': '记住上次已上传的文件，下次扫描只传新增或有变化的路径。',
  'dataRelay.scan.resetCheckpoint': '清除上次上传记录',
  'dataRelay.scan.lastPass': '最近扫描：{time}',
  'dataRelay.context.copyPath': '复制路径',
  'dataRelay.context.paste': '粘贴',
  'dataRelay.context.openTerminal': '在此打开终端',
  'dataRelay.context.copySuccess': '已复制 {count} 项',
  'dataRelay.context.pasteSuccess': '已粘贴 {count} 项',
  'dataRelay.context.pasteEmpty': '剪贴板为空',
  ...
  'dataRelay.context.uploadDir': '上传子目录(覆盖)',
  'dataRelay.context.uploadDirConfirm': '上传并覆盖',
  'dataRelay.context.uploadDirConfirmTitle': '上传并覆盖「{name}」',
  'dataRelay.context.uploadDirConfirmDesc': '将把该目录下的全部文件和子目录上传到目标位置,并覆盖目标处已存在的内容。',
  'dataRelay.context.uploadDirSource': '来源',
