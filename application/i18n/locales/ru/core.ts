...
`,
  ...
  'vault.nav.dataRelay': 'Ретрансляция данных',

  // Data Relay
  'dataRelay.new': 'Новая ретрансляция',
  'dataRelay.searchPlaceholder': 'Поиск ретрансляций...',
  'dataRelay.startAll': 'Запустить все',
  'dataRelay.stopAll': 'Остановить все',
  'dataRelay.viewGrid': 'Сетка',
  'dataRelay.viewList': 'Список',
  'dataRelay.saved': 'Ретрансляция сохранена',
  'dataRelay.transferred': 'Передано',
  'dataRelay.empty.title': 'Пока нет ретрансляций',
  'dataRelay.empty.description': 'Передавайте папку с одного хоста в папку другого хоста в реальном времени.',
  'dataRelay.error.saveFailed': 'Не удалось сохранить ретрансляцию',
  'dataRelay.status.inactive': 'Остановлено',
  'dataRelay.status.connecting': 'Подключение',
  'dataRelay.status.active': 'Передача',
  'dataRelay.status.error': 'Ошибка',
  'dataRelay.status.unknown': 'Неизвестно',
  'dataRelay.writeMode.overwrite': 'Перезаписать',
  'dataRelay.writeMode.append': 'Дописать',
  'dataRelay.form.newTitle': 'Новая ретрансляция данных',
  'dataRelay.form.editTitle': 'Изменить ретрансляцию данных',
  'dataRelay.form.labelPlaceholder': 'напр. журналы Windows в Linux',
  'dataRelay.form.sourceHost': 'Исходный хост',
  'dataRelay.form.sourcePath': 'Исходная папка',
  'dataRelay.form.sourcePathPlaceholder': '/var/log/',
  'dataRelay.form.sourcePathHint': 'Выберите папку на исходном хосте. Файлы внутри неё передаются в реальном времени.',
  'dataRelay.form.sourceCommand': 'Исходная команда',
  'dataRelay.form.sourceCommandPlaceholder': 'tail -f /var/log/app.log',
  'dataRelay.form.sourceCommandHint': 'Выполняется на исходном хосте; её стандартный вывод ретранслируется.',
  'dataRelay.form.destHost': 'Целевой хост',
  ...
  'dataRelay.form.autoStartHint': 'Автоматически запускать ретрансляцию при запуске Netcatty.',
  'dataRelay.form.selectHost': 'Выберите хост',
  'dataRelay.browser.sourceTitle': 'Выберите исходную папку',
  'dataRelay.browser.destTitle': 'Выберите целевую папку',
  'dataRelay.browser.select': 'Выбрать',
  'dataRelay.browser.selectFolder': 'Выбрать эту папку',
  ...
  'dataRelay.compare.comparing': 'Рекурсивное сравнение…',
  'dataRelay.compare.comparingProgress': 'Просмотрено {scanned}, различий {diffs}',
  'dataRelay.compare.dialogTitle': 'Синхронизация',
  'dataRelay.compare.dialogHint': 'Выберите направление и скопируйте отмеченные различия.',
  'dataRelay.compare.direction': 'Направление',
  'dataRelay.compare.direction.toDest': 'Источник → Назначение',
  'dataRelay.compare.direction.toSource': 'Назначение → Источник',
  'dataRelay.compare.direction.both': 'Оба',
  'dataRelay.compare.search': 'Фильтр путей',
  'dataRelay.compare.selectAll': 'Выбрать все',
  'dataRelay.compare.selectNone': 'Снять выбор',
  'dataRelay.compare.sync': 'Синхронизировать',
  'dataRelay.compare.checkedCount': 'Выбрано {checked} из {total}',
  'dataRelay.compare.copyingProgress': 'Копирование {done}/{total}…',
  'dataRelay.compare.noDirectionItems': 'В этом направлении нечего копировать.',
  'dataRelay.compare.summary.same': 'Одинаковые',
  'dataRelay.compare.summary.leftOnly': 'Только слева',
  'dataRelay.compare.summary.rightOnly': 'Только справа',
  'dataRelay.compare.summary.different': 'Различаются',
  'dataRelay.compare.kind.newerLeft': 'Новее в источнике',
  'dataRelay.compare.kind.newerRight': 'Новее в назначении',
  'dataRelay.compare.kind.size': 'Разный размер',
  'dataRelay.compare.kind.type': 'Разный тип',
  'dataRelay.compare.kind.content': 'Разное содержимое',
  'dataRelay.compare.noDifferences': 'Папки совпадают рекурсивно.',
  'dataRelay.compare.logEmpty': 'Сравнение открывает список различий. Выберите направление и синхронизируйте отмеченные файлы.',
  'dataRelay.compare.logHint': 'Здесь отображается ход копирования и сравнения.',
  'dataRelay.scan.settings': 'Параметры сканирования',
  'dataRelay.scan.interval': 'Интервал сканирования',
  'dataRelay.scan.intervalHint': 'Как часто искать новые или изменённые файлы, пока ретрансляция запущена. Первый поиск начинается сразу.',
  'dataRelay.scan.seconds': 'секунд',
  'dataRelay.scan.minutes': 'минут',
  'dataRelay.scan.mode': 'Что копировать',
  'dataRelay.scan.mode.mtime': 'По времени создания/изменения',
  'dataRelay.scan.mode.mtimeHint': 'Сравнивает источник и назначение по размеру и времени и копирует новые или более свежие файлы источника.',
  'dataRelay.scan.mode.checkpoint': 'С последней загрузки',
  'dataRelay.scan.mode.checkpointHint': 'Запоминает файлы последней загрузки и в следующий раз копирует только новые или изменённые пути.',
  'dataRelay.scan.resetCheckpoint': 'Очистить запись последней загрузки',
  'dataRelay.scan.lastPass': 'Последнее сканирование: {time}',
  'dataRelay.context.copyPath': 'Копировать путь',
  'dataRelay.context.paste': 'Вставить',
  'dataRelay.context.openTerminal': 'Открыть терминал здесь',
  'dataRelay.context.copySuccess': 'Скопировано элементов: {count}',
  'dataRelay.context.pasteSuccess': 'Вставлено элементов: {count}',
  'dataRelay.context.pasteEmpty': 'Буфер обмена пуст',
  ...
  'dataRelay.context.uploadDir': 'Отправить подкаталог (с заменой)',
  'dataRelay.context.uploadDirConfirm': 'Отправить с заменой',
  'dataRelay.context.uploadDirConfirmTitle': 'Отправить с заменой «{name}»',
  'dataRelay.context.uploadDirConfirmDesc': 'Все файлы и подкаталоги этой папки будут отправлены в место назначения, заменив уже существующее там содержимое.',
  'dataRelay.context.uploadDirSource': 'Источник',
