...
export const enVaultMessages: Messages = {
  ...
  'hostDetails.remoteShellCommand.placeholder': 'git-bash or "C:\\Program Files\\Git\\bin\\bash.exe" --login -i',
  ...
  'hostDetails.remoteShellCommand.emptyHint':
    'On Windows OpenSSH, an empty value uses Git Bash when it is installed. Click Git Bash to require it, or Server default to keep cmd/PowerShell.',
  'hostDetails.remoteShellCommand.preset.gitBash': 'Git Bash',
  'hostDetails.remoteShellCommand.preset.serverDefault': 'Server default',
