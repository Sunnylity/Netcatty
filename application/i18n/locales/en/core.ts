...
`,
  ...
  'dataRelay.empty.description': 'Stream a command output from one host straight into a file on another host, in real time.',
  ...
  'dataRelay.form.destPath': 'Destination file',
