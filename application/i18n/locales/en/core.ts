...
`,
  ...
  'vault.nav.dataRelay': 'Data Relay',

  // Data Relay
  'dataRelay.new': 'New Relay',
  'dataRelay.searchPlaceholder': 'Search relays...',
  'dataRelay.startAll': 'Start All',
  'dataRelay.stopAll': 'Stop All',
  'dataRelay.viewGrid': 'Grid view',
  'dataRelay.viewList': 'List view',
  'dataRelay.saved': 'Data relay saved',
  'dataRelay.transferred': 'Transferred',
  'dataRelay.empty.title': 'No data relays yet',
  'dataRelay.empty.description': 'Stream files from a folder on one host into a folder on another host, in real time.',
  'dataRelay.error.saveFailed': 'Could not save the data relay',
  'dataRelay.status.inactive': 'Stopped',
  'dataRelay.status.connecting': 'Connecting',
  'dataRelay.status.active': 'Streaming',
  'dataRelay.status.error': 'Error',
  'dataRelay.status.unknown': 'Unknown',
  'dataRelay.writeMode.overwrite': 'Overwrite',
  'dataRelay.writeMode.append': 'Append',
  'dataRelay.form.newTitle': 'New Data Relay',
  'dataRelay.form.editTitle': 'Edit Data Relay',
  'dataRelay.form.labelPlaceholder': 'e.g. Windows logs to Linux',
  'dataRelay.form.sourceHost': 'Source host',
  'dataRelay.form.sourcePath': 'Source folder',
  'dataRelay.form.sourcePathPlaceholder': '/var/log/',
  'dataRelay.form.sourcePathHint': 'Choose a folder on the source host. Files inside it are streamed live.',
  'dataRelay.form.sourceCommand': 'Source command',
  'dataRelay.form.sourceCommandPlaceholder': 'tail -f /var/log/app.log',
  'dataRelay.form.sourceCommandHint': 'Runs on the source host; its standard output is relayed.',
  'dataRelay.form.destHost': 'Destination host',
  ...
  'dataRelay.form.autoStartHint': 'Automatically start this relay when Netcatty starts.',
  'dataRelay.form.selectHost': 'Select host',
  'dataRelay.browser.sourceTitle': 'Select source folder',
  'dataRelay.browser.destTitle': 'Select destination folder',
  'dataRelay.browser.select': 'Select',
  'dataRelay.browser.selectFolder': 'Select this folder',
  ...
  'dataRelay.compare.comparing': 'Comparing recursively…',
  'dataRelay.compare.comparingProgress': 'Scanned {scanned} entries, {diffs} differences',
  'dataRelay.compare.dialogTitle': 'Synchronize',
  'dataRelay.compare.dialogHint': 'Choose a direction, then copy the checked differences.',
  'dataRelay.compare.direction': 'Direction',
  'dataRelay.compare.direction.toDest': 'Source → Destination',
  'dataRelay.compare.direction.toSource': 'Destination → Source',
  'dataRelay.compare.direction.both': 'Both',
  'dataRelay.compare.search': 'Filter paths',
  'dataRelay.compare.selectAll': 'Select all',
  'dataRelay.compare.selectNone': 'Select none',
  'dataRelay.compare.sync': 'Synchronize',
  'dataRelay.compare.checkedCount': '{checked} of {total} selected',
  'dataRelay.compare.copyingProgress': 'Copying {done}/{total}…',
  'dataRelay.compare.noDirectionItems': 'Nothing to copy in this direction.',
  'dataRelay.compare.summary.same': 'Same',
  'dataRelay.compare.summary.leftOnly': 'Left only',
  'dataRelay.compare.summary.rightOnly': 'Right only',
  'dataRelay.compare.summary.different': 'Different',
  'dataRelay.compare.kind.newerLeft': 'Newer on source',
  'dataRelay.compare.kind.newerRight': 'Newer on destination',
  'dataRelay.compare.kind.size': 'Size differs',
  'dataRelay.compare.kind.type': 'Type differs',
  'dataRelay.compare.kind.content': 'Contents differ',
  'dataRelay.compare.noDifferences': 'The two folders match recursively.',
  'dataRelay.compare.logEmpty': 'Compare opens a checklist of nested differences. Choose a direction and synchronize the checked files.',
  'dataRelay.compare.logHint': 'Copy and compare activity appears here.',
  'dataRelay.scan.settings': 'Scan settings',
  'dataRelay.scan.interval': 'Scan interval',
  'dataRelay.scan.intervalHint': 'How often to look for new or changed files while the relay is running. The first scan starts immediately.',
  'dataRelay.scan.seconds': 'seconds',
  'dataRelay.scan.minutes': 'minutes',
  'dataRelay.scan.mode': 'What to copy',
  'dataRelay.scan.mode.mtime': 'Add / modify time',
  'dataRelay.scan.mode.mtimeHint': 'Compare source and destination by size and timestamps, then copy files that are new or newer on the source.',
  'dataRelay.scan.mode.checkpoint': 'Since last upload',
  'dataRelay.scan.mode.checkpointHint': 'Remember files copied on the last scan and only upload paths that were added or changed.',
  'dataRelay.scan.resetCheckpoint': 'Clear last-upload record',
  'dataRelay.scan.lastPass': 'Last scan: {time}',
  'dataRelay.context.copyPath': 'Copy path',
  'dataRelay.context.paste': 'Paste',
  'dataRelay.context.openTerminal': 'Open terminal here',
  'dataRelay.context.copySuccess': 'Copied {count} item(s)',
  'dataRelay.context.pasteSuccess': 'Pasted {count} item(s)',
  'dataRelay.context.pasteEmpty': 'Nothing to paste',
  ...
  'dataRelay.context.uploadDir': 'Upload subfolder (overwrite)',
  'dataRelay.context.uploadDirConfirm': 'Upload and overwrite',
  'dataRelay.context.uploadDirConfirmTitle': 'Upload and overwrite "{name}"',
  'dataRelay.context.uploadDirConfirmDesc': 'Every file and subfolder under this directory will be uploaded to the destination, replacing what already exists there.',
  'dataRelay.context.uploadDirSource': 'Source',
